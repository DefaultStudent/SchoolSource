...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <form class="form-search" method="post" name="myform" action="getProfessionalByName" onsubmit="test()">
            ...
            <table class="table table-condensed">
                ...
                <s:iterator value="PageBean.list">
                    <tr class="success">
                        ...
                        <td>
                            <s:a href="getProfessionalById?pid=%{pid}">修改</s:a>&nbsp;|&nbsp;<s:a href="removeProfessionl?pid=%{pid}">删除</s:a>
                        </td>
                    </tr>
                </s:iterator>
                <tr align="center">
